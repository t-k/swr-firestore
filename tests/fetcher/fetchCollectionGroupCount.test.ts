...
import { fetchCollectionGroupCount } from "../../src";
import { db } from "../supports/fb";
import { deleteCollection } from "../supports/fbUtil";

const parentCollection = "FetchCollectionGroupCountParent";
const subCollection = "FetchSubCollectionGroupCountTest";
...
describe("fetchCollectionGroupCount", () => {
  const testData = [
  ...
  test("count all documents in collection group", async () => {
    const result = await fetchCollectionGroupCount<TestDoc>({
      path: subCollection,
    });

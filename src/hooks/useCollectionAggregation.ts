...
import type { KeyParamsForAggregate } from "../util/type";
...
const useCollectionAggregation = <T>(
  params: KeyParamsForAggregate<T> | null,
...
export default useCollectionAggregation;
